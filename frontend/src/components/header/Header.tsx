...
const Header = () => {
    return (
        <header className="z-[999] relative">
            <nav className="fixed flex items-center justify-between w-full p-4 md:px-8 border-b border-solid border-gold-600 bg-shark max-w-10xl top-0 left-1/2 -translate-x-1/2 bg-opacity-95">
                <Demyth />
